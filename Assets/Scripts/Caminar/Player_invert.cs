...
public class Player_invert : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        anim.SetFloat("VelZ", -z); // Invert vertical input

        float x = Input.GetAxisRaw("Horizontal");
        anim.SetFloat("VelX", -x); // Invert horizontal input

        Vector3 movement = new Vector3(-Input.GetAxis("Horizontal"), 0f, -Input.GetAxis("Vertical")); // Invert movement vector
