...
public class Dialogue_salacristales3 : MonoBehaviour
{
    ...
    private void NextDialogueLine()
    {
        ...
        if (lineIndex >= dialogueLines.Length)
        {
            ...
            objectToActivate.SetActive(true);
            Invoke("AfterCinematic", 2.0f);
            Debug.Log("conversationEnded after Invoke: " + conversationEnded);
        }
    }
    void AfterCinematic()
    {
        Debug.Log("AFTER WAITING");
        Debug.Log("conversationEnded: " + conversationEnded);
        if (conversationEnded)
        {
            SceneManager.LoadScene("Scene_21");
        }
    }
